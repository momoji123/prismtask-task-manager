...
class Api:
    ...
    def load_task(self, token, taskId):
        ...
        query = """
            ...
            SELECT t.*, s.description as status 
    ...
    def load_tasks_summary(self, token, filters={}, pagination={}):
        ...
        sql_query = """
            ...
            SELECT t.id, t.creator, t.title, t."from", t.priority, t.deadline, t.finishDate, 

                   s.description as status, t.categories, t.createdAt, t.updatedAt 
        ...
        group_by_map = {
            ...
            'priority': 't.priority ASC', 'from': 't."from" ASC', 'status': 'status ASC',
        ...
        sort_by_map = {
            ...
            'priority': 't.priority ASC', 'from': 't."from" ASC', 'updatedAt': 't.updatedAt DESC',
